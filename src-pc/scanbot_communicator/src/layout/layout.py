...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.drive_step_slider.setMaximum(150)
        ...
        self.auto_drive_btn = QPushButton(self.centralwidget)
        self.auto_drive_btn.setObjectName(u"auto_drive_btn")
        self.auto_drive_btn.setGeometry(QRect(320, 290, 101, 31))
        self.get_azimuth_kalman_btn = QPushButton(self.centralwidget)
        self.get_azimuth_kalman_btn.setObjectName(u"get_azimuth_kalman_btn")
        self.get_azimuth_kalman_btn.setGeometry(QRect(440, 290, 101, 31))
        self.label_21 = QLabel(self.centralwidget)
        self.label_21.setObjectName(u"label_21")
        self.label_21.setGeometry(QRect(320, 270, 151, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tab_container.setTabText(self.tab_container.indexOf(self.pole_plot_tab), QCoreApplication.translate("MainWindow", u"map", None))
...
"DATA", None))
        ...
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"BASIC FUNCTIONS", None))
...
#endif // QT_CONFIG(shortcut)
        self.auto_drive_btn.setText(QCoreApplication.translate("MainWindow", u"AUTO DRIVE", None))
#if QT_CONFIG(shortcut)
        self.auto_drive_btn.setShortcut(QCoreApplication.translate("MainWindow", u"Space", None))
#endif // QT_CONFIG(shortcut)
        self.get_azimuth_kalman_btn.setText(QCoreApplication.translate("MainWindow", u"GET_AZIMUTH\n"
"USING KALMAN", None))
        self.label_21.setText(QCoreApplication.translate("MainWindow", u"EXTENDED FUNCTIONS", None))
    # retranslateUi
